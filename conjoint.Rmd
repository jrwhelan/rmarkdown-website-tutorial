...
[`formr`](https://formr.org) offers an interesting interface to build and run surveys with `R`. Because it leverages `R` code, you can run code chunks within a survey, which allows us to do a lot of interesting things with experimental designs and choice experiments, but for now we consider a basic conjoint example.
